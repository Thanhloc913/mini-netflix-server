...
export class Init1757326029923 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."account_role_enum" AS ENUM('USER', 'ADMIN')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "profiles" ADD CONSTRAINT "FK_a443220e6eb2480b1514c8b6203" FOREIGN KEY ("accountId") REFERENCES "account"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "profiles" DROP CONSTRAINT "FK_a443220e6eb2480b1514c8b6203"`,
    );
